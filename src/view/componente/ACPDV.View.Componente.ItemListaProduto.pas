...
type
  ...
  public
    ...
    function Embed(aValue: TWinControl): TframeComponenteListaItem;
...
begin
  Result := Self;
  Self.pnlSubTotalProduto.Caption := FormatCurr('"R$ ",0.00', (FValorUnitario * FQuantidade));
end;
...
begin
  ...
  Self.lblDescricaoProduto.Caption := aValue;
end;

function TframeComponenteListaItem.Embed(aValue: TWinControl): TframeComponenteListaItem;
begin
  Result := Self;
  Self.Parent := aValue;
end;
...
begin
  Result := Self;
  FQuantidade := aValue;
  Self.pnlQuantidadeProduto.Caption := FormatFloat(',0.000', FQuantidade);
end;
...
begin
  ...
  Self.pnlValorUnitarioProduto.Caption := FormatCurr('"R$ ",0.00', FValorUnitario);
end;
